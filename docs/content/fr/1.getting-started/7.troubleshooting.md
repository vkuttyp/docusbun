...
Si vous rencontrez des erreurs lors du build ou du développement avec `bun`, en particulier liées à la dépendance `better-sqlite3`, il se peut que vous deviez approuver certains paquets pour qu’ils puissent être compilés.
