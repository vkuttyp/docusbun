...
If you encounter build or dev errors when using `bun`, especially related to `better-sqlite3` dependency, you might need to approve certain packages for building.
